...
int main(int argc, char **argv) {
    ...
    int matrix1_rows = size; // Número de linhas da matriz 1
    int matrix2_cols = atoi(argv[2]); // Número de colunas da matriz 2


    int terceiro_parm = atoi(argv[1]);

    int matrix1_cols = terceiro_parm; // Número de colunas da matriz 1
    int matrix2_rows = terceiro_parm; // Número de linhas da matriz 2
